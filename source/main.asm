...
textwriter:
	;Get cursor color counter
	lda $f4
	
	;If it is 20, reset it to 0
	cmp #19
	...
	;Check the screen pause counter
	lda $fb
	cmp #$00
...
pause:
	...
	;If the pause is done, clear the screen
	lda $fb
	cmp #$00
	beq clearscreen
	rts
...
;Push color memory, text color memory and screen color pointer offsets
pushoffsets:
	;Clear carry
	clc
...
;Push text data pointer offsets
pushoffsets2:
	;Clear carry
	clc
...
;Add timer value to screen pause counter
nextscreen:
	lda #$ff
	sta $fb
	rts
